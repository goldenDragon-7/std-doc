...
// dispatch each to mermaid (if it carries mermaid source) or ascii.
...
// statetrackSource builds the D2 source for a state machine.
...
// swimlaneSource builds the D2 source for a swimlane.
