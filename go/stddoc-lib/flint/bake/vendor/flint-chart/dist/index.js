...
export { DEFAULT_GAS_PRESSURE_PARAMS, DEFAULT_NESTED_SNAP_THRESHOLD, STATIC_SERIES_KEY_COLUMN, STATIC_SERIES_VALUE_COLUMN, SemanticTypes, adaptChannels, applyEncodingOverrides, applyPivot, assembleChartjs, assembleECharts, assembleVegaLite, channelGroups, channels, cjsAdaptChart, cjsAllTemplateDefs, cjsApplyLayoutToSpec, cjsApplyTooltips, cjsGetTemplateChannels, cjsGetTemplateDef, cjsRecommendEncodings, cjsTemplateDefs, coerceEncodingValue, computeAxisStep, computeChannelBudgets, computeElasticBudget, computeFacetLayout, computeGasPressure, computeLabelSizing, computeLayout, computeOverflow, computePaddedDomain, computePivot, computeZeroDecision, convertTemporalData, detectBandedAxisForceDiscrete, detectBandedAxisFromSemantics, ecAdaptChart, ecAllTemplateDefs, ecApplyLayoutToSpec, ecApplyTooltips, ecGetTemplateChannels, ecGetTemplateDef, ecRecommendEncodings, ecTemplateDefs, filterOverflow, getChartOptions, getChartPivot, getChartjsPivot, getEChartsPivot, getRecommendedColorScheme, getRegistryEntry, getVisCategory, getZeroClass, inferOrdinalSortOrder, inferVisCategory, isCategoricalType, isGeoType, isMeasureType, isOrdinalType, isTimeSeriesType, laneCountForMode, makeCartesianPivot, makeSortAction, normalizeAnnotation, normalizeEncodingShorthand, normalizeStaticSeries, planBandDodge, recommendChannels, resolveAggregationDefault, resolveBandDodge, resolveBinningSuggested, resolveCanonicalOrder, resolveChannelSemantics, resolveColorSchemeHint, resolveCyclic, resolveDefaultVisType, resolveDivergingInfo, resolveDodge, resolveDomainConstraint, resolveEncodingType, resolveFieldSemantics, resolveFormat, resolveNice, resolveReversed, resolveScaleType, resolveSortDirection, resolveStackable, resolveTickConstraint, resolveZeroClassFromAnnotation, toTypeString, vlAdaptChart, vlAllTemplateDefs, vlApplyLayoutToSpec, vlApplyTooltips, vlGetTemplateChannels, vlGetTemplateDef, vlRecommendEncodings, vlTemplateDefs };
