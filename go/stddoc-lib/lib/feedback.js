...
(function () {
  ...
  // Presence heartbeat written by engine/scripts/watch.py. A FRESH beat means
  ...
  // kingdom-wide so the default is neutral, but a specific doc can label it via
  // window.__cfWhisperHeading or a data-cf-whisper-heading attribute on <body>
  // or <html> (the cfv3 board sets it to "Mr. Dragon's whispers").
  ...
  function findAnchorNode(anchor) {
    ...
    //      walkthrough survives `publish.py` re-running (PRD P0-1);
