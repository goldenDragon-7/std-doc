...
not hand-written HTML. The HTML becomes a build artifact (`stddoc publish`). This
...
├── index.html      # derived (stddoc publish) — never hand-edited
