...
--purple:#a78bfa; --lavender:#c4b5fd;  /* questions, calls, "your call" */
...
| 🟣 lavender/purple | a *question* · a call · "◀ YOUR CALL" · the delegatable lane |
...
else. `stddoc serve` wires it; `stddoc freeze` bakes it to static SVG for snapshots. The
...
A calls section ends in decisions. Most decisions are **multiple-choice** — so
